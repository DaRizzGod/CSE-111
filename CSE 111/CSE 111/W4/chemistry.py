...
print('This is made for the people that are too lazy to look at a table and make choices:')
Symbol_index: 0
Name_index: 1 
Atomic_Mass_index: 2 
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    """
    total_molar_mass = 0
    for table in symbol_quantity_list:
        symbol = table[0]
        quantity = table[1]
...
def main():
    ...
    mass = float(input('Please enter the mass of the chemical in grams: '))
    ...
    print(f'THe number of moles in the sample group is: {moles}')
