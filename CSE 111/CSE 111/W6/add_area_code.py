...
# At line 12, write a call to the Python map function and pass the
# add_area_code function and phone_numbers list as arguments to the map function.

# At line 32, write code that checks if the length of a phone number is less 
# than 12 and if the length is less than 12 then adds the area code "208-" at the
