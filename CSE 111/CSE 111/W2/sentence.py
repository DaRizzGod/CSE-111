...
def main():
    print(f'Welcome to the auto sentence maker!! Here is your english for the week: ')
...
def make_sentence(quantity, tense):
    ...
    """
    return (f'{get_determiner(quantity)} {get_noun(quantity)} {get_verb(quantity,tense)} {get_preposition()} {get_prepositional_phrase(quantity)}')
